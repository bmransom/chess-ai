...
| Measure strength — SPRT vs the PeSTO build (@bmransom, `feat/nnue-eval`) | In progress | [nnue-eval](specs/nnue-eval/design.md) | Training pipeline, Incremental accumulator, Fair-match harness + acceptance rule |
